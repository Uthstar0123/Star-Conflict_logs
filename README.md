...
- ✅ Просмотр истории матчей с возможностью загрузить любой бой (ПОКА НЕ РЕАЛИЗОВАНО - В ПРОЦЕССЕ) 
- ✅ **Тёмная/светлая тема** и настройка прозрачности окна
- ✅ Полностью автономная работа, не требует подключения к интернету
...
1. Клонируйте репозиторий:
   ```bash
   git clone https://github.com/yourusername/star-conflict-log-analyzer.git
